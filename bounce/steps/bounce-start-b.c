...
ball_t ball = {.pos.x=1, .pos.y=1, .inc.x=1, .inc.y=0};
...
void play()
{
    ...
    if(ball.pos.x>=screen.pos.x+screen.size.x)
        ball.pos.x = screen.pos.x+1;
    // do not go over the left side
    if(ball.pos.x<screen.pos.x)
        ball.pos.x = screen.pos.x+screen.size.x-1;
    // do not go over the bottom side
    if(ball.pos.y>=screen.pos.y+screen.size.y)
        ball.pos.y = screen.pos.y+1;
    // do not go over the top side
    if(ball.pos.y<screen.pos.y)
        ball.pos.y = screen.pos.y+screen.size.y-1;
